...
def main():
    parser = argparse.ArgumentParser(
        description="Calculate average SSIM, MSE, and MAE between images in two folders."
    )
    parser.add_argument(
        "--folder1", type=str, required=True, help="Path to the first folder"
    )
    parser.add_argument(
        "--folder2", type=str, required=True, help="Path to the second folder"
    )
