...
MODEL_PATH_DEEPCACHE=$(python3 -c "from huggingface_hub import snapshot_download; repo_id='siliconflow/stable-diffusion-v1-5-onediff-deepcache-int8'; deepcache_int8_folder = snapshot_download(repo_id=repo_id); print(deepcache_int8_folder)")

OUTPUT_DIR="your path"

python3 text_to_image_sd1_5_enterprise_quality_benchmark.py --model $MODEL_PATH_DEEPCACHE --image_path $OUTPUT_DIR --deep_cache True
