...
python3 models/sd/text_to_image_sd1_5_enterprise_quality_benchmark.py --model $MODEL_DEEPCACHE_PATH --image_path $OUTPUT_DIR --deep_cache True
python3 models/sd/text_to_image_sd1_5_enterprise_quality_benchmark.py --model $MODEL_PATH --image_path $OUTPUT_DIR
python3 models/sd/text_to_image_sd1_5_quality_benchmark.py --image_path $OUTPUT_DIR
python3 models/sd/text_to_image_sd1_5_quality_benchmark.py --image_path $OUTPUT_DIR --deep_cache False
python3 models/sd/text_to_image_sd1_5_quality_benchmark.py --image_path $OUTPUT_DIR --compile False --deep_cache False
